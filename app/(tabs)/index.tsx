...
function HealthScoreGauge({ score, colors }: { score: number | null; colors: any }) {
  return (
    <View className="bg-[#0F172A] border border-white/10 rounded-3xl p-8">
        ...
        <View className="p-6 gap-6">
          ...
          {projects.length > 0 && (
            <View className="flex-row gap-6">
              ...
              <View className="flex-1 bg-[#0F172A] border border-white/10 rounded-3xl p-8">
          ...
          <View className="gap-4">
            {loading ? (
              ...
              <View className="bg-[#0F172A] border border-white/10 rounded-3xl p-12 items-center gap-4">
              ...
              <View className="bg-[#0F172A] border border-white/10 rounded-2xl p-8 items-center gap-4">
